...
{
    /// <summary>
    /// Client for the APIVerve.API.WordLexiconAnalyzer API
    /// </summary>
    public class WordLexiconAnalyzerAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/lexicon";
        ...
        public WordLexiconAnalyzerAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public WordLexiconAnalyzerAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public WordLexiconAnalyzerAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, WordLexiconAnalyzerQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        public ResponseObj Execute(WordLexiconAnalyzerQueryOptions options = null)
        {
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        public Task<ResponseObj> ExecuteAsync(WordLexiconAnalyzerQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(WordLexiconAnalyzerQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(WordLexiconAnalyzerQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(WordLexiconAnalyzerQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(WordLexiconAnalyzerQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(WordLexiconAnalyzerQueryOptions options)
        {
