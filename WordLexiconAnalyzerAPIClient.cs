...
namespace APIVerve
{
    public class WordLexiconAnalyzerAPIClient
    {
        ...
        public WordLexiconAnalyzerAPIClient(string apiKey, bool isSecure = true)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
        }
        ...
        public WordLexiconAnalyzerAPIClient(string apiKey, bool isSecure = true, bool isDebug = false)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
            _isDebug = isDebug;
